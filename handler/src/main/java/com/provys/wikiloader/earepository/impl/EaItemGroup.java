...
abstract class EaItemGroup<E extends EaElementRef, R extends EaItemGroupRef<E, R, G>,
        G extends EaItemGroup<E, R, G>> extends EaParentBase<R, EaDiagramRef, E, R> {
    ...
    Exporter getExporter(ProvysWikiClient wikiClient) {
        return new EaItemGroupExporter(this, wikiClient);
    }
}
